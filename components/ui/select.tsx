...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex h-9 w-full min-w-0 items-center justify-between gap-2 rounded-md border border-border bg-background px-3 py-1.5 text-sm whitespace-nowrap transition-colors outline-none data-[placeholder]:text-muted-foreground data-[size=sm]:h-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground [&>span]:min-w-0 [&>span]:truncate",
        ...
        "md:text-sm/relaxed dark:bg-card",
        className
      )}
      {...props}
    >
